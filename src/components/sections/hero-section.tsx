      ...
      <main className="container grid grid-cols-1 lg:grid-cols-2 items-center max-w-[1400px] mx-auto px-6 lg:px-8">
        <div className="flex flex-col gap-4 w-fit mx-auto p-5 sm:p-0 lg:-mt-10 text-center lg:text-left items-center lg:items-start">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4">
            ...
            <a
              href={config?.links?.whatsapp || "https://wa.me/905015260754"}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-semibold text-white rounded-lg transition-all duration-200 hover:opacity-90 hover:scale-105 shadow-lg"
            ...
            >
              ...
              {currentLanguage === 'tr' ? 'WhatsApp' : 'WhatsApp'}
            </a>
            <a
              href={config?.links?.social?.instagram || "https://instagram.com/bimakas.app"}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-semibold text-white rounded-lg transition-all duration-200 hover:opacity-90 hover:scale-105 shadow-lg"
              style={{ 
            ...
            <a
              href={config?.links?.social?.linkedin || "https://linkedin.com/company/bimakas"}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-semibold text-white rounded-lg transition-all duration-200 hover:opacity-90 hover:scale-105 shadow-lg"
            ...
            >
              ...
              {currentLanguage === 'tr' ? 'LinkedIn' : 'LinkedIn'}
            </a>
          </div>
